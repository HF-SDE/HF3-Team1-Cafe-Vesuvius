 ...
 * 
 * @param {TextInputLabelProp} label - label for the text input @see https://reactnative.dev/docs/textinput#label
 * @param {string} value - value for the text input @see https://reactnative.dev/docs/textinput#value
 ...
 * @param {StyleProp<TextStyle>} style - custom style for the text input @see https://reactnative.dev/docs/textinput#style
 ...
 * @returns {*}
 */
export default function CustomTextInput({ label, value, onChange, style, clearButtonMode = "never", autoComplete = "off", autoCapitalize = "sentences", clearTextOnFocus = true, enablesReturnKeyAutomatically = false, enterKeyHint = "next", inputMode = "text"  }: InputProps) {
