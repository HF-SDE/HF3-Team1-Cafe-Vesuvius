...
export class PermissionManager {
  ...
  private permissionsToPages: { [key: string]: string[] } = {
    "administrator:stats:view": ["ManagmentPage", "StatsPage"],
    "administrator:users:view": ["ManagmentPage", "UsersPage"],
    "administrator:users:update": ["ManagmentPage", "UsersPage"],
    "administrator:users:create": ["ManagmentPage", "UsersPage"],
    "administrator:users:management": ["ManagmentPage", "UsersPage"],
    "administrator:permission:create": ["ManagmentPage", "PermissionPage"],
    "administrator:permission:view": ["ManagmentPage", "PermissionPage"],
    ...
    "stock:view": ["ManagmentPage", "StockPage"],
    "stock:update": ["ManagmentPage", "StockPage"],
    "stock:create": ["ManagmentPage", "StockPage"],
