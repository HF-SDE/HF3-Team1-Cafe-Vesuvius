...
const sampleOrders: OrderItem[] = [
  ...
  {
    id: "6",
    items: [{ name: "Burger", quantity: 2, price: 8.0 }],
    total: 16.0,
  },
  { id: "7", items: [{ name: "Fries", quantity: 3, price: 3.0 }], total: 9.0 },
  {
    id: "8",
    items: [{ name: "Smoothie", quantity: 2, price: 5.5 }],
    total: 11.0,
  },
  {
    id: "9",
    items: [{ name: "Pizza", quantity: 1, price: 12.0 }],
    total: 12.0,
  },
  ...
  {
    id: "14",
    items: [{ name: "Muffin", quantity: 3, price: 2.0 }],
    total: 6.0,
  },
  {
    id: "15",
    items: [{ name: "Burrito", quantity: 1, price: 7.5 }],
    total: 7.5,
  },
  { id: "16", items: [{ name: "Tacos", quantity: 2, price: 3.0 }], total: 6.0 },
  {
    id: "17",
    items: [{ name: "Quesadilla", quantity: 1, price: 6.0 }],
    total: 6.0,
  },
  {
    id: "18",
    items: [{ name: "Waffle", quantity: 2, price: 4.0 }],
    total: 8.0,
  },
  { id: "19", items: [{ name: "Donut", quantity: 4, price: 1.5 }], total: 6.0 },
  {
    id: "20",
    items: [{ name: "Ice Cream", quantity: 1, price: 3.0 }],
    total: 3.0,
  },
  { id: "21", items: [{ name: "Bagel", quantity: 2, price: 2.0 }], total: 4.0 },
  {
    id: "22",
    items: [{ name: "Falafel", quantity: 3, price: 2.5 }],
    total: 7.5,
  },
  {
    id: "23",
    items: [{ name: "Sushi", quantity: 5, price: 2.0 }],
    total: 10.0,
  },
  {
    id: "24",
    items: [{ name: "Noodles", quantity: 1, price: 5.0 }],
    total: 5.0,
  },
  {
    id: "25",
    items: [{ name: "Ramen", quantity: 2, price: 6.5 }],
    total: 13.0,
  },
  {
    id: "26",
    items: [{ name: "Steak", quantity: 1, price: 15.0 }],
    total: 15.0,
  },
  { id: "27", items: [{ name: "Fish", quantity: 2, price: 9.0 }], total: 18.0 },
  {
    id: "28",
    items: [{ name: "Chicken Wings", quantity: 6, price: 1.5 }],
    total: 9.0,
  },
  {
    id: "29",
    items: [{ name: "Pancakes", quantity: 3, price: 3.5 }],
    total: 10.5,
  },
  {
    id: "30",
    items: [{ name: "Hot Dog", quantity: 2, price: 3.0 }],
    total: 6.0,
  },
];
